...
function App() {
  ...
  const selectionContext = createContext(categories);
  useEffect(() => {
  ...
  */
  ...
  const handleCompanyRegister=(e)=>{
   ...
   /*
      ...
      setCompanyInputs({ company_name: '', location:'', contact_phone: '', category_id: null, company_description:'' })
    ...
    return (
      <>
        ...
        <Routes> 
          ...
          <Route path="/registercompany" element={<RegisterCompany  onChange={handleCompanyChange} onSubmit={handleCompanyRegister} cat={categories}/>}/>
